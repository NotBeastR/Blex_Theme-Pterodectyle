...
installTheme(){
    cd /var/www/
    tar -cvf BlexTheme.tar.gz pterodactyl
    echo "Installing theme..."
    cd /var/www/pterodactyl
    rm -r BlexTheme
    git clone https://github.com/NotBeastR/Blex_Theme-Pterodectyle.git
    cd BlexTheme
    rm /var/www/pterodactyl/resources/scripts/BlexTheme.css
    ...
    mv resources/scripts/BlexTheme.css /var/www/pterodactyl/resources/scripts/BlexTheme.css
...
repair(){
    bash <(curl https://raw.githubusercontent.com/NotBeastR/Blex_Theme-Pterodectyle/main/repair.sh)
}

restoreBackUp(){
    echo "Restoring backup..."
    cd /var/www/
    tar -xvf BlexTheme.tar.gz
    rm BlexTheme.tar.gz
...
echo ""
echo "Copyright (c) 2024 NotBeastR | https://discord.gg/7PgU9WYBgc"
echo "This program is free software: you can easily use it"
echo ""
echo "Discord: https://discord.gg/7PgU9WYBgc"
echo ""
